...
const Navbar = ({ onMenuClick, setActiveTab }) => {
  return (
    <header className="flex items-center justify-between px-4 md:px-8 h-16 md:h-20 border-b border-zinc-100 bg-white/80 backdrop-blur-md sticky top-0 z-20 w-full">
